    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-x-4 gap-y-6">
                ...
                <Contact fullName="Hugo DU PELOUX" catchPhrase="Average Coding Enjoyer" image="/images/people/hugo_du_peloux.png" linkedIn="https://www.linkedin.com/in/hugo-du-peloux/" />
